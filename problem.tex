...
\end{figure}
		Вышеописанная марковская цепь обладает предельным распределением (при $t \to \infty$), соответствующим собственному вектору матрицы перехода при единичном собственном значении. Это свойство значительно упростит нашу задачу.